...
if __name__ == '__main__':
    file_with_recipes = os.path.abspath(r'\Users\ew345\Desktop\hw\recipes.txt')
    ...
    file_for_writing = os.path.abspath(r'\Users\ew345\Desktop\hw\Result.txt')
    base_path = os.getcwd()
    location = os.path.abspath(r'\Users\ew345\Desktop\hw\ ')
